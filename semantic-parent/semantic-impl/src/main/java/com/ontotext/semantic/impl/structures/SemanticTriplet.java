...
public class SemanticTriplet implements Triplet {
	...
	public String toString() {
		...
		sb.append(SemanticSparqlUtil.SINGLE_SPACE);
		sb.append(getFirst()).append(SemanticSparqlUtil.SINGLE_SPACE);
		sb.append(getSecond()).append(SemanticSparqlUtil.SINGLE_SPACE);
		sb.append(getThird());
